          ...
          <div className="bg-[#0a0a0a] border border-white/10 rounded-3xl p-8 sticky top-32 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
            <div className="flex flex-col items-center">
              ...
              <div className="relative group mb-6">
                <div className="absolute -inset-1 bg-gradient-to-r from-gray-500 to-white rounded-full blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200 animate-pulse"></div>
                {profile?.avatar_url ? (
