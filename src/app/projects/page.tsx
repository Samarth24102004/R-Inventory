    ...
    <main className="relative bg-black min-h-screen text-white selection:bg-[#84cc16]/30 flex flex-col">
      ...
      <div className="pt-32 pb-32 px-6 md:px-12 max-w-7xl mx-auto grow w-full relative z-10">
        <div className="text-center mb-16 relative z-20">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto drop-shadow-sm">Explore premium ROS 2 projects complete with components, circuit diagrams, commands, and source code downloads.</p>
        </div>
